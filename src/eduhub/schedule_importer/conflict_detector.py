...
from .models import ScheduleRow, ConflictError
...
class ConflictDetector:
    ...
    def _detect_room_conflicts(self, indexed_rows: List[Tuple[int, ScheduleRow]]) -> None:
    ...
    def _detect_instructor_conflicts(self, indexed_rows: List[Tuple[int, ScheduleRow]]) -> None:
    ...
    def _detect_duplicate_entries(self, indexed_rows: List[Tuple[int, ScheduleRow]]) -> None:
        ...
        for idx, row in indexed_rows:
            ...
            if signature in seen_entries:
                ...
                self.conflicts.append(ConflictError(
                    row_numbers=[original_idx + 2, idx + 2],  # +2 for 1-based + header
    ...
    def _check_time_overlaps(self, entries: List[Tuple[int, ScheduleRow]], conflict_type: str, resource_name: str) -> None:
