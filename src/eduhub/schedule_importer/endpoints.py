...
from .models import ImportSummary, ErrorResponse
...
async def import_schedule(
    file: UploadFile = File(..., description="CSV or Excel file containing schedule data"),
    preview_only: bool = Form(False, description="If true, validate and preview without creating content"),
