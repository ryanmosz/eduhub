...
class ConflictError(BaseModel):
    ...
    conflict_type: str = Field(
        ..., description="Type of conflict (room, instructor, etc.)"
    )
...
class ImportSummary(BaseModel):
    ...
    created_uids: Optional[list[str]] = Field(
        None, description="UIDs of created Plone content"
    )
    ...
    rollback_performed: bool = Field(
        False, description="Whether rollback was necessary"
    )
